...
export default function VenueCard({ venue, onClick }: VenueCardProps) {
	...
	return (
		<div
			onClick={onClick}
			className="bg-white rounded-lg shadow-md cursor-pointer hover:shadow-lg transition-shadow duration-200 border border-gray-100 overflow-hidden"
		>
			{/* Photo Section */}
			...
			<div className="p-4">
				<div className="flex justify-between items-start mb-2">
					...
					{highestRating && (
						<div
							className={`flex items-center px-2 py-1 rounded-full text-sm font-medium ml-2 flex-shrink-0 ${getRatingBgColor(
								highestRating.value!
